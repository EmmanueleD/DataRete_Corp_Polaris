  ...
  >
    ...
    >
      ...
      <span v-if="message.files.length > 0">
        <div>
          <!-- {{ fileExtention('https://polaris-core.datarete.cloud'+message.files[0].file_url)[0] }} -->
          <img
            style="width: 100%"
            v-if="
              fileExtention(
                'https://polaris-core.datarete.cloud' +
            ...
            "
            :src="
              'https://polaris-core.datarete.cloud/' + message.files[0].file_url
            "
          />
