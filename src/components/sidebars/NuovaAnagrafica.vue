<template>
  ...
  <div v-else class="wrapper">
    <Card v-if="showAnagrafica" class="mb-4">
      ...
      <template #content>
        <div class="p-input-filled form-group">
          <div class="w-full grid">
            <div class="flex flex-column col-12 col-md-4 col-xl-3">
              <label>Agente propietario</label>
            ...
            <div class="flex flex-column col-12 col-md-4 col-xl-3">
              <label>Referente analisi</label>
              <InputText type="text"></InputText>
            </div>

            <div class="flex flex-column col-12 col-md-4 col-xl-3">
              <label>Stato anagrafica</label>
              <InputText type="text"></InputText>
            </div>
            ...
            <div class="flex flex-column col-12 col-md-4 col-xl-3">
              <label>Numero aziende gruppo</label>
              <InputText type="text"></InputText>
            </div>

            <div class="flex flex-column col-12 col-md-4 col-xl-3">
              <label>Numero azionisti</label>
              <InputText type="text"></InputText>
            </div>

            <div class="flex flex-column col-12 col-md-4 col-xl-3">
              <label>Numero partecipate</label>
              <InputText type="text"></InputText>
            </div>
          </div>
