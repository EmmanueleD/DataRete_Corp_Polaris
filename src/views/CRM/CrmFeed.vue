<template>
  ...
  <div class="wrapper">
    ...
    <TabView ref="tabview1" v-model:activeIndex="active" :scrollable="true">
      ...
      <TabPanel header="ANAGRAFICA"></TabPanel>
      <TabPanel header="BILANCI">
        <Bilanci></Bilanci>
      </TabPanel>
      <TabPanel header="INDICI"></TabPanel>
      <TabPanel header="NEGATIVITA'"></TabPanel>
      <TabPanel header="STORICO STATI"></TabPanel>
      <TabPanel header="CRM"></TabPanel>
      <TabPanel header="KEY PEOPLE"></TabPanel>
      <TabPanel header="CONTATTI"></TabPanel>
      <TabPanel header="PRATICHE"></TabPanel>
      <TabPanel header="APPUNTAMENTI"></TabPanel>
      <TabPanel header="REFERRAL ANALISI"></TabPanel>
      <TabPanel header="ANALISI MODEFINANCE"></TabPanel>
      <TabPanel header="PREVALUTAZIONI"></TabPanel>
    </TabView>
  </div>
  <Sidebar
...
import Bilanci from "@/components/tabs/Bilanci.vue"
